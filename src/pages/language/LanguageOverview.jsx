          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 'var(--space-lg)', flexWrap: 'wrap' }}>
            ...
            <div>
              <h1 style={{
                ...
                letterSpacing: '-0.03em', color: 'var(--color-text-primary)', marginBottom: '8px',
              }}>
                Learn {lang.name}<span style={{ color: lang.color }}> ·</span>
              </h1>
        ...
        <div>
          ...
          <section style={{ marginBottom: 'var(--space-xl)' }}>
            ...
            <div style={{ display: 'grid', gap: '10px' }}>
              {roadmap.whyLearn.map(function(reason, i) {
                return (
                  <div key={i} style={{
          ...
          <section style={{ marginBottom: 'var(--space-xl)' }}>
            ...
            <div style={{ display: 'grid', gap: '10px' }}>
              {Object.entries(roadmap.timeline).map(function(entry) {
                const stage = entry[0]
                const time = entry[1]
                return (
                  <div key={stage} style={{
                    ...
                    <span style={{ fontFamily: 'var(--font-body)', fontSize: '14px', fontWeight: 600, color: 'var(--color-text-primary)', textTransform: 'capitalize' }}>
                      {stage}
                    </span>
                    <span style={{
          ...
          <section>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 'var(--space-md)' }}>
              <h2 style={{ fontFamily: 'var(--font-display)', fontSize: '22px', fontWeight: 700 }}>Roadmap overview</h2>
              <Link to={'/languages/' + lang.id + '/roadmap'} style={{ fontFamily: 'var(--font-body)', fontSize: '13px', fontWeight: 600, color: lang.color }}>
                Full roadmap →
              </Link>
            </div>
            <div style={{ display: 'grid', gap: '10px' }}>
              {roadmap.levels.map(function(level) {
                return (
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--space-md)', position: isMobile ? 'static' : 'sticky', top: '80px' }}>
          ...
          <div style={{
            ...
            <Link to={'/languages/' + lang.id + '/roadmap'} style={{
              display: 'block', fontFamily: 'var(--font-body)', fontSize: '14px', fontWeight: 600,
